    ...
    <div>
        <div class="box">
            ...
            <el-card class="box-card">
                ...
                <ve-line :data="lineData1" :settings="lineSettings"></ve-line>
            </el-card>
            <el-card class="box-card">
                <div slot="header" class="clearfix">
                    <span>成交量</span>
                </div>
                <ve-histogram :data="lineData2"></ve-histogram>
            </el-card>
            <el-card class="box-card">
                <div slot="header" class="clearfix">
                    <span>vivo手机销售比例</span>
                </div>
                <ve-pie :data="lineData3"></ve-pie>
            </el-card>
            <el-card class="box-card">
                <div slot="header" class="clearfix">
                    <span>手机品牌销售比例</span>
                </div>
                <ve-ring :data="lineData4"></ve-ring>
            </el-card>
            <el-card class="box-card">
                <div slot="header" class="clearfix">
                    <span>购买人群</span>
                </div>
                <ve-funnel :data="lineData5"></ve-funnel>
            </el-card>
            <el-card class="box-card">
                <div slot="header" class="clearfix">
                    <span>北京上海广州销售量</span>
                </div>
                <ve-scatter :data="lineData6"></ve-scatter>
            </el-card>
            <el-card class="box-card">
                <div slot="header" class="clearfix">
                    <span>历年交易量</span>
                </div>
                <ve-candle :data="lineData7"></ve-candle>
            </el-card>
        </div>
    </div>
</template>
